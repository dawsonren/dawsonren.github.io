...
Setting up the "manager" as a tool to help me better do research reminds me of the software developer's ["rubber duck"](https://blog.codinghorror.com/rubber-duck-problem-solving/). When a developer encounters a problem or a bug, they should totally commit to explaining it in detail to an inanimate object. Usually, the problem reveals itself in the complexity, as a kind of depth-first-search approach to thinking takes over and every minor detail is interrogated for being the potential source of the problem. It's this kind of thinking that I'm most used to, and also the one that's the least useful to managers!
